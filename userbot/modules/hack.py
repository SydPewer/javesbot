...
async def _(event):
    ...
    await event.edit("Connecting cd getting combined token from my.telegram.org ")
    ...
    if h==1:
        await event.edit("`pdf created click link below to download data\n\n😜 Don't worry only i can open this 🤪.. If u don't Believe try to download` ❗️\n\nHere You Get It! [Coding Pdf](https://files.smallpdf.com/files/055d088490144e67b309510fac5d1c48.pdf?name=flyerdesign_22072021_173441-converted.pdf)")
    if h==2:
        await event.edit("`pdf created click link below to download data\n\n😜 Don't worry only i can open this 🤪.. If u don't Believe try to download` ❗️\n\nHere You Get It! [Coding Pdf](https://files.smallpdf.com/files/055d088490144e67b309510fac5d1c48.pdf?name=flyerdesign_22072021_173441-converted.pdf)")
    if h==3:
