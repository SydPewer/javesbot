...
async def repo_is_here(wannasee):
    ...
    await wannasee.reply(
        f"This bot just re and re-edited From Javes To Javes-2.0 \n Click [here](https://dashboard.heroku.com/new?button-url=https%3A%2F%2Fgithub.com%2FJaves786%2Fjaves-2.0&template=https%3A%2F%2Fgithub.com%2FJaves786%2Fjaves-2.0) to open my javes\n =>Join channel for more information @javes2support")
